...
(function() {
    ...
    '<div class="shake"><div class="head"><div class="headtitle">{{{title}}}</div>' +
    '<div class="items-container"><div class="menu-items">' +
    '{{#elements}}' +
    '<div class="menu-item {{#selected}}selected{{/selected}}">' +
    '<span class="marker"><i class="fas fa-angle-right"></i>&nbsp;</span> {{{label}}}{{#isSlider}} : &lt;{{{sliderLabel}}}&gt;{{/isSlider}}' +
    '</div>' +
    '{{/elements}}' +
    '</div></div></div>' +
    '</div>' +
    ...
    ESX_MENU.render = function() {
        ...
        if (focused) {
            if ($('.selected').length >= 1) {
                $('#menu_' + focused.namespace + '_' + focused.name).find('.menu-item.selected')[0].scrollIntoView(false);
                $('#menu_' + focused.namespace + '_' + focused.name).find('.menu-item.selected')[0].scrollIntoView(false);
                        ...
                        case 'BACKSPACE':
                            {
                                ...
                                animacion = false;
                                if (typeof focused != 'undefined') {
                                    $(".menu").addClass("cerrarMenu").fadeOut(400, function() {
                        ...
                        case 'RIGHT':
                            {
                                ...
                                if (typeof focused != 'undefined') {
                                    ...
                                    switch (elem.type) {
                                        ...
                                        case 'slider':
                                            {
                                                let max = typeof elem.max == "undefined" ? elem.options.length - 1 : elem.max;
